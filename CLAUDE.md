...
**Gaps (1):**
- T8: 2 of 7 <img> missing dims


Run `/home/deploy/bin/perf-traits-audit.sh kevin-white-us` for full detail. Remediation guidance in [performance-gate.md](/home/deploy/claude-config/rules/performance-gate.md).
<!-- perf-traits:end -->
